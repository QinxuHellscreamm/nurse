    ...
    <div class='out-main'>
      ...
      <el-table :data='LIST'>
        ...
        <el-table-column  label="项目名称" width="180">
          <template slot-scope="scope">
            <el-select v-model='scope.row.CODE' @change='signChange' @focus='focu(scope.$index)'	filterable size='mini'>
        ...
        <el-table-column  label="一天几次" width="180">
          <template slot-scope="scope">
            <el-input v-model='scope.row.NUMBER_OF_TIMES' :readonly='scope.row.NUMBER_OF_TIMES_REVISABILITY == 1' size='mini'></el-input>
          </template>
        </el-table-column>
