    ...
    <el-form ref="ruleForm" :model="ruleForm" label-width="80px"  :rules="rules">
      ...
      <div class="opinion" >
        ...
        <el-form-item  label-width="0px"  prop="HEAD_NURSE_EVENT_GRADE" >
          <el-radio-group v-model="ruleForm.HEAD_NURSE_EVENT_GRADE" :disabled="role_rank == 3">
        ...
        <el-form-item  label-width="0px"  prop="EVENT_REASON">
          <el-checkbox-group v-model="ruleForm.EVENT_REASON" :disabled="role_rank == 3">
        ...
        <el-form-item  label-width="0px" prop="UPDATE_ADVICE">
          <p style="font-size: 16px;">护士长审核意见</p>
        <el-input :disabled="role_rank == 3"
          type="textarea"
          :autosize="{ minRows: 2, maxRows: 4}"
          placeholder="请输入护士长审核意见"
      ...
      <div class="opinion" v-if="role_rank == 3">
        ...
        <el-form-item  label-width="0px"  prop="MANAGE_NURSE_EVENT_GRADE">
          <el-radio-group v-model="ruleForm.MANAGE_NURSE_EVENT_GRADE">
            <el-radio label="1">Ⅰ级事件（警告事件）：非预期的死亡，或是非疾病自然进展过程中造成永久性功能丧失</el-radio><br>
            <el-radio label="2">Ⅱ级事件（不良后果事件）：在疾病医疗过程中是因诊疗活动而非疾病本身造成的病人机体与功能损害</el-radio><br>
            <el-radio label="3">Ⅲ级事件（未造成后果事件）：虽然发生的错误事实，但未给病人机体与功能造成任何损害，或有轻微后果而不需任何处理即可完全康复</el-radio><br>
            <el-radio label="4">Ⅳ级事件（隐患事件）：由于及时发现错误，但未形成事实</el-radio>
  ...
  export default {
    data() {
      return {
        ...
        ruleForm: {
          EVENT_REASON:[],
          HEAD_NURSE_EVENT_GRADE: '',
          MANAGE_NURSE_EVENT_GRADE: '',
          PATIENT_TYPE: '1',
        },
        selectedOptions2: [],
        id:'',
...
//          ],
    ...
    methods: {
      ...
      draftSub(formName){
        //if(this.draft == true){
          this.ruleForm.HEAD_NURSE_EVENT_GRADE=String(this.ruleForm.HEAD_NURSE_EVENT_GRADE)
          this.ruleForm.MANAGE_NURSE_EVENT_GRADE=String(this.ruleForm.MANAGE_NURSE_EVENT_GRADE)
          ...
          this._put('datacenter/infaustevent/'+ this.ruleForm.ID, {...obj,IS_DRAFT:1},res =>{
            console.log("1111_put_put_put",res)
