...
/*护理管理*/
  ...
  import ViewReport from '@managePlatform/adverseEvent/manage/viewReport'
    ...
    methods:{
      ...
      deal_route_one(){
            ...
            if (this.platforms.length == 1){
                ...
                if (this.platforms[this.platforms.length-1].code == 'work_station')
                {
                    this.if_workstation()
                    return
                }
                if (this.platforms[this.platforms.length-1].code == 'manage')
                {
                    this.if_manage()
                    return
                }
                if (this.platforms[this.platforms.length-1].code == 'systerm')
                {
                    this.if_systerm()
                    return
                }
