<template>
  <div class="this_content">
    <div class='out-top'>
      ...
      <el-button type="primary" icon="el-icon-printer" style="float: right;" @click='print'></el-button>
    </div>
    <div class="out-main">
  ...
  export default {
   ...
   components : { nurseView , shiftManagement ,schedulingView},
    ...
    methods : {
      ...
      print(){
        this.viewName == "排班视图" ? this.$refs.nurseView.print() : this.$refs.nurseView.print()
      },
    ...
    watch:{
      'week':function () {
        this.week.getDay() == 2 ? this.week = new Date(this.week.getTime() - 86400000) : null
        ...
        this.weekDays = []
        for(let i = 0 ; i < 7 ; i++){
          let day = new Date(Date.parse(this.week) + ( i  * 86400000))
