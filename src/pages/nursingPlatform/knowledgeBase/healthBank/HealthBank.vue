  ...
  <div class="headlthBank">
    ...
    <div class="out-main">
      <el-table :data="modelList" style="width: 100%">
        ...
        <el-table-column prop="CATEGORY" label="关联科室" min-width='300'></el-table-column>
        <el-table-column label="最后编辑时间" min-width='100'>
          <template slot-scope="{row}">
            <div>{{row.UPDATED_AT | stampTotime}}</div>
          </template>
        </el-table-column>
        <el-table-column prop="USERNAME" label="操作人" min-width='76'></el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button @click="viewItem(scope.row.ID)" type="text" size="small" style='padding: 0;'>查看</el-button>
            <el-button @click="editItem(scope.row.ID)" type="text" size="small" style='padding: 0;'>编辑</el-button>
            <el-button @click.native.prevent="deleteRow(scope.row.ID)" type="text" size="small" style='padding: 0;'>删除</el-button>
          </template>
        </el-table-column>
      </el-table>
