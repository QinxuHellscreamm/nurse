<template>
  <div>
    ...
    <el-switch v-model="print_mian" active-text="双面打印" inactive-color="#ccc" style='float: right;margin: 10px 20px; padding-top: 10px'></el-switch>
    <div class='content'>
    ...
    export default {
        ...
        methods:{
          ...
          print_preview(){
            ...
            this.print_mian ? LODOP.SET_PRINT_MODE("DOUBLE_SIDED_PRINT",true) : null;//手动双面控制
