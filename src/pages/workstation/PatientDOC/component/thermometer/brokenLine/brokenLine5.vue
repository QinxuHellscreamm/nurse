  ...
  <div class='line2'>
    <svg style='width: 755px;height:90px'>
      ...
      <template v-for='item of spotArr'>
        <circle :cx="item.x" :cy="item.y" r="5" fill="" stroke=""  v-if='item.type==""'/>
        <g style="font-size: 18pt;">
          ...
          <text :x="item.x-5" :y="item.y+4" font-size="30" style="fill:black" v-if='item.type==3'><tspan style='font-size: 12px;'>⊙</tspan></text>
          <text :x="item.x-5" :y="item.y+6" font-size="30" style="fill:black" v-if='item.type==4'><tspan style='font-size: 16px;'>▼</tspan></text>
          <text :x="item.x-5" :y="item.y+6" font-size="30" style="fill:black" v-if='item.type==5'><tspan style='font-size: 24px;'>○</tspan></text>
