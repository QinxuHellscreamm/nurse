      ...
      <el-dialog :visible.sync="popshow" width='960px' class='custom'>
        <div slot='title'>
          ...
          <div class='patient_detile'>
            ...
            <span>住院号:</span><span>{{detile.MEDICAL_RECORD_NUM}}</span>
            ...
            <tr>
              ...
              <th v-for='itemVlaue of item.ITEMS' :style="{border:'1px solid #D8E3E7',borderLeft:'none',borderTop:'none'}">
                ...
                <div v-if='item.SIGN_CODE != "T10700" && item.SIGN_CODE != "T10900"'>
                  ...
                  <el-input v-model='itemVlaue[0].VS_VALUE' v-if='item.INPUT_TYPE_CODE == "01" || item.INPUT_TYPE_CODE == "02"' :maxlength='item.INPUT_LENGTH' :class="{'err':itemVlaue[0].err}" @change='type_update(itemVlaue[0],item.VALIDATION_RULE,item.NAME)'></el-input>
                  <el-autocomplete
                ...
                <div v-if='item.SIGN_CODE == "T10700"' class='t10700'>
                  <template v-for='(sub,subindex) of item.SIGN_SUB'>
                    ...
                    <el-input v-model='itemVlaue[subindex+1].VS_VALUE' v-show='sub.INPUT_TYPE_CODE == "01" || sub.INPUT_TYPE_CODE == "02"' :maxlength='sub.INPUT_LENGTH' :disabled= "itemVlaue[1].VS_VALUE == 1" v-if='sub.SIGN_CODE != T10702' @change='type_update(itemVlaue[subindex+1],sub.VALIDATION_RULE)' :class="{'err':itemVlaue[0].err}"></el-input>
                  </template>
                ...
                <div v-if='item.SIGN_CODE=="T10900"'>
                  ...
                  <el-input v-model='itemVlaue[0].VS_VALUE' :disabled='itemVlaue[1].VS_VALUE == 1' v-if='item.INPUT_TYPE_CODE == "01" || item.INPUT_TYPE_CODE == "02"' :maxlength='item.INPUT_LENGTH' @change='type_update(itemVlaue[0],item.VALIDATION_RULE)' :class="{'err':itemVlaue[0].err}"></el-input>
                </div>
              </th>
            </tr>
            </tbody>
    ...
    export default {
        ...
        methods : {
          change_t10700(val){
            ...
            val == 1 ? this.arr_t10700[3].VS_VALUE = '0' : this.arr_t10700[3].VS_VALUE = ''
          },
          focus_t10702(val){
            console.log(val)
            this.arr_t10700 = val
          ...
          change_t10900(val){
            val == 1 ? this.arr_t10900[0].VS_VALUE = '0' : this.arr_t10900[0].VS_VALUE = ''
          },
          focus_t10900(val){
            console.log(val)
            this.arr_t10900 = val
