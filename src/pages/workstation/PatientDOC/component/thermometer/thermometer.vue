<template>
    <div style='padding:20px; background-color: #FFFFFF'>
      ...
      <svg width='850' height='1300' ref="print" :style='{transform:"scale("+scale+")"}' style='transform-origin: 10px 10px;'>
                ...
                <tbody>
                  ...
                  <template v-for='(item,i) of pulseTemperature'>
                    <tr>
                      ...
                      <td v-for='(item2,index) of td42null'  height='12px' :colspan='ten' :class='{"red":index % 6 == 5}'></td>
                    </tr>
                    <tr v-for='(td,s) of td4null' >
                      <td v-for='(item2,index) of td42null'  height='12px' :colspan='ten' :class='{"red":index % 6 == 5,"bottom": i == 4 && s == 3 }'></td>
                    </tr>
                  </template>
                  <template>
                    <tr>
    ...
    export default {
        ...
        data (){
          return{
            ...
            pulseTemperature : [
              ...
              { pulse : 180 , temperature : '40℃'},
              { pulse : 160 , temperature : '39℃'},
              { pulse : 140 , temperature : '38℃'},
              { pulse : 120 , temperature : '37℃'},
              { pulse : 100 , temperature : '36℃'},
              { pulse : 80 , temperature : '35℃'},
              { pulse : 60 , temperature : '34℃'},
        ...
        methods : {
          ...
          print(){
            ...
            var strBodyStyle="<style>table{border-collapse:collapse;} h2{font-size: 50px;margin: 0;font-family: Simsun,Georgia; height: 20px;} p{font-family: Simsun,Georgia;height: 20px; font-size: 14px;} .line2{position: absolute;left:94px;top:752px;} .line{position:absolute;left:94px;top:84px;} th{ font-family: Simsun,Georgia; font-weight: normal;font-size: 14px;}  td{ text-align: center; font-size:14px;min-width:9px;min-height: 13px; font-family: Simsun,Georgia} twd_event{display: none;} .span{transform :scale(0.65);display: block;width: 12px;position: relative;left: -2px;} .top{top:-10px;!important;position:relative;} .pp span{position: relative;top:5px;} .line3{position: absolute;left: 90px; top:82px;}</style>";
