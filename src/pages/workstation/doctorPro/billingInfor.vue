      ...
      <div  class="pro-ribot">
        ...
        <el-table ref="multipleTable" :data="execRecord" tooltip-effect="dark" @row-contextmenu='rightClick' style="width: 100%">
         <!-- <el-table-column type="selection" min-width="32"></el-table-column>-->
          ...
          <el-table-column prop="ACTUAL_EXEC_TIME" label="执行时间" width="134"></el-table-column>
          <el-table-column prop="EXEC_USER_NAME" label="执行人" width="80"></el-table-column>
          <!--成组的情况-->
          ...
          <el-table-column prop="PATIENT_NAME" label="患者姓名" width="76"></el-table-column>
          <el-table-column prop="MEDICAL_RECORD_NUM" label="住院号" width="66"></el-table-column>
          <el-table-column prop="AGE" label="年龄" width="60"></el-table-column>
          <el-table-column prop="BED_NUMBER" label="床位号" width="60"></el-table-column>
          <el-table-column prop="TYPE_NAME" label="类型" width="76"></el-table-column>
          <el-table-column prop="SINGLE_DOSE_STR" label="用量" min-width="60"></el-table-column>
          <el-table-column prop="USAGE" label="用法" min-width="110" show-overflow-tooltip></el-table-column>
          <el-table-column prop="CHANNEL" label="途径" min-width="76"></el-table-column>
          <el-table-column prop="ENTRUST" label="嘱托" min-width="150"></el-table-column>
          <el-table-column prop="address" label="是否皮试" width="76">
            <template slot-scope="scope">
              {{scope.row.TYPE == "3" ? '√':''}}
            </template>
          </el-table-column>
          <el-table-column prop="SKIN_TEST_RESULT" label="皮试结果" width="76"></el-table-column>
        </el-table>
       <!-- <div class="botBtn">
    ...
    export default{
      ...
      methods:{
        ...
        edit(){
          this.popshow = true
          this.fixShow = false
          this.startTime = this.obj.ACTUAL_EXEC_TIME
        },
        del(){
          /*this.fixShow = false
