<template>
    <div class='shift_report'>
      <div class='out-main'>
       <div class='sort-box'>
         <el-date-picker v-model="date" value-format='yyyy-MM-dd' format="yyyy-MM-dd" type="date" placeholder="选择日期"></el-date-picker>
    ...
    export default {
      ...
      methods : {
        ...
        flagTime(){
          ...
          this.ban_start = this.options[0].BEGINT_TIME
        ...
        sortsele(vId){
          ...
          this.ban_start = obj.BEGINT_TIME
            ...
            this.recordDa[i+1] = {ID:item.ID,NAME:item.NAME,SEX:item.SEX,AGE:item.AGE,DIAGNOSTIC_RESULTS:item.DIAGNOSTIC_RESULTS,tol:'编辑'};
              item.record_content.forEach(itemRecord =>{
                 ...
                 if(itemRecord.SHEET_ID == this.ruleForm.sheet[0].SH_ID ){
                   ...
                   this.recordDa[i+1]["SHID0"] = this.recordDa[i+1]["SHID0"] ?  this.recordDa[i+1]["SHID0"] : ""
                 }
                 ...
                 if(itemRecord.SHEET_ID == this.ruleForm.sheet[1].SH_ID){
                   ...
                   this.recordDa[i+1]["SHID1"] =  this.recordDa[i+1]["SHID1"] ? this.recordDa[i+1]["SHID1"] : ''
                 }
                 ...
                 if(itemRecord.SHEET_ID == this.ruleForm.sheet[2].SH_ID){
                   ...
                   this.recordDa[i+1]["SHID2"]  = this.recordDa[i+1]["SHID1"] ? this.recordDa[i+1]["SHID1"] : ""
                 }
